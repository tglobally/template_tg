...
<div class="overlay-navigation">
    <nav role="navigation">
        <ul>
            <li><a class="nav-element" href="#" data-content="<?php echo $subtitulo0?>" id="Home-text-0"></a></li>
            <li><a class="nav-element" href="#" data-content="<?php echo $subtitulo1?>" id="Home-text-1" >About</a></li>
            <li><a class="nav-element" href="#" data-content="<?php echo $subtitulo2?>" id="Home-text-2">Skills</a></li>
            <li><a class="nav-element" href="#" data-content="<?php echo $subtitulo3?>" id="Home-text-3">Works</a></li>
            <li><a class="nav-element" href="#" data-content="<?php echo $subtitulo4?>" id="Home-text-4">Contact</a></li>
        </ul>
    </nav>
</div>